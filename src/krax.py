...
m3 = EquipmentROT(q = plc.M3_ISON, rot = plc.M3_BELT, fault = plc.M3_ROPE, start = plc.M3_START, 
                        stop = plc.M3_STOP, manual = plc.M3_MAN, depends = m2, lock = plc.M3_ROPE, slave_addr=2)

m4 = Equipment(q = plc.M4_ISON, depends=m3, start = plc.M4_START, stop = plc.M4_STOP, manual = plc.M4_MAN, fault=None, lock=None)

m5 = EquipmentROT(q = plc.M5_ISON, rot = plc.M5_BELT, fault = plc.M5_ROPE, start = plc.M5_START, 
                        stop = plc.M5_STOP, manual = plc.M5_MAN, depends = m4, lock = plc.M5_ROPE, slave_addr=9)

m6 = Equipment(q = plc.M6_ISON, depends=m5, start = plc.M6_START, stop = plc.M6_STOP, manual = plc.M6_MAN, fault=None, lock=None)

m7 = EquipmentROT(q = plc.M7_ISON, rot = plc.M7_BELT, fault = plc.M7_ROPE, start = plc.M7_START, 
                        stop = plc.M7_STOP, manual = plc.M7_MAN, depends = m6, lock = plc.M7_ROPE, slave_addr=10)

m8 = EquipmentPack(q = plc.M8_ISON, rot = plc.M8_BELT, fault = plc.M8_ROPE, start = plc.M8_START, 
                        stop = plc.M8_STOP, manual = plc.M8_MAN, depends = m7, lock = plc.M8_ROPE, gate=plc.PACK1, slave_addr=11)

m10 = EquipmentROT(q = plc.M10_ISON, rot = plc.M10_BELT, fault = plc.M10_ROPE, start = plc.M10_START, 
                        stop = plc.M10_STOP, manual = plc.M10_MAN, depends = m6, lock = plc.M10_ROPE, slave_addr=3)
...
m13 = EquipmentAutoStart(q = plc.M13_ISON, depends=m11, start = plc.M13_START, stop = plc.M13_STOP, manual = plc.M13_MAN, auto_start_on=(m11, m14))

m15 = Equipment(q = plc.M15_ISON, depends=m14, start = plc.M15_START, stop = plc.M15_STOP, manual = plc.M15_MAN, fault=None, lock=None)

m16 = EquipmentROT(q = plc.M16_ISON, rot = plc.M16_BELT, fault = plc.M16_ROPE, start = plc.M16_START, 
                        stop = plc.M16_STOP, manual = plc.M16_MAN, depends = m15, lock = plc.M16_ROPE, slave_addr=6)

m17 = Equipment(q = plc.M17_ISON, depends=m16, start = plc.M17_START, stop = plc.M17_STOP, manual = plc.M17_MAN, fault=None, lock=None)

m18 = EquipmentROT(q = plc.M18_ISON, rot = plc.M18_BELT, fault = plc.M18_ROPE, start = plc.M18_START, 
                        stop = plc.M18_STOP, manual = plc.M18_MAN, depends = m17, lock = plc.M18_ROPE, slave_addr=12)

m19 = EquipmentROT(q = plc.M19_ISON, rot = plc.M19_BELT, fault = plc.M19_ROPE, start = plc.M19_START, 
                        stop = plc.M19_STOP, manual = plc.M19_MAN, depends = m17, lock = plc.M19_ROPE, slave_addr=13)

m20 = EquipmentPack(q = plc.M20_ISON, rot = plc.M20_BELT, fault = plc.M20_ROPE, start = plc.M20_START, 
                        stop = plc.M20_STOP, manual = plc.M20_MAN, depends = m19, lock = plc.M20_ROPE, gate=plc.PACK2, slave_addr=7)
